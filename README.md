...
The Sophgo host-tools GCC (10.2.0) shipped with the reCamera SDK is too old for Rust 1.85+ — its binutils cannot handle the RISC-V ISA extensions that LLVM 19 emits. Use the [riscv-collab toolchain](https://github.com/riscv-collab/riscv-gnu-toolchain/releases) (binutils 2.39+) instead.
